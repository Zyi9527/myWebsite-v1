// asciiLoader.js – 严格按照 React Bits ASCIIText 重写
...
export class AsciiLoader {
  constructor(container, { text = 'LOADING', enableWaves = true, asciiFontSize = 10 } = {}) {
    this.container = container;
    this.textString = text;
    this.asciiFontSize = asciiFontSize;
    this.textFontSize = 200;
    this.textColor = '#ffffff';
    this.planeBaseHeight = 8;
  ...
  setRenderer() {
    ...
    this.renderer.setClearColor(0x0a0a0f, 1.0);   // 深色背景，完全不透明
